        ...
        <section className={cn(UI.max, "pt-12 pb-10")}>
          <Reveal>
            <h1 className={UI.h1}>
              ...
              — propre, cohérent, vendable.
            </h1>
          </Reveal>

          <Reveal delay={0.08}>
            <p className={cn("mt-5 max-w-3xl text-base md:text-lg", UI.subtle)}>
              Portrait, corporate, food, éditorial : direction claire, retouches clean, livrables web + print.
              Tu repars avec une galerie qui renforce ton image.
            </p>
          </Reveal>
          ...
          <Reveal delay={0.16}>
            <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {[
                { k: "Direction", v: "Pose + intention" },
                { k: "Retouches", v: "Clean / pro" },
                { k: "Livraison", v: "Web + print" },
                { k: "Cohérence", v: "Série prête branding" },
              ].map((x) => (
        ...
        <section className={cn(UI.max, "pb-10")}>
          <Reveal>
            <div className={cn(UI.card, "p-7")}>
              <h2 className={UI.h2}>
                Inclus{" "}
                <span className="text-[#F5C518]">dans chaque</span> session
              </h2>

              <div className="mt-6 grid gap-3 md:grid-cols-2">
                {[
                  "Brief rapide + références (style / mood)",
                  "Direction (poses, cadrage, énergie)",
                  "Sélection (meilleures images) + retouches pro",
                  "Exports web (réseaux) + print (si demandé)",
                  "Galerie livrée propre + conseils d’utilisation",
                  "Option : visuels adaptés site / presse / Google Business",
                ].map((p) => (
        ...
        <section className={cn(UI.max, "pb-10")}>
          <Reveal>
            ...
            <p className={cn("mt-2 text-sm md:text-base max-w-3xl", UI.subtle)}>
              Tu choisis un niveau. On ajuste selon durée, lieu, quantité d’images.
            </p>
          </Reveal>
            ...
            {[
              {
                ...
                rec: false,
                d: "Idéal pour une photo pro/branding sans se compliquer.",
                b: ["Direction simple", "Sélection + retouches clean", "Exports web prêts", "Livraison rapide"],
              },
              {
                t: "Branding",
                hint: "Artistes / business",
                rec: true,
                d: "Une série cohérente pour site, réseaux, presse, Google Business.",
                b: ["Direction + cohérence visuelle", "Retouches avancées", "Variantes cadrage (web/print)", "Galerie livrée propre"],
              },
              {
                t: "Editorial",
                hint: "Signature visuelle",
                rec: false,
                d: "Identité forte : style, intention, rendu signature.",
                b: ["Moodboard + direction", "Retouches avancées", "Cohérence artistique", "Livraison premium"],
              },
            ].map((p, i) => (
              <motion.div
                key={p.t}
            ...
            <Reveal>
              <div className="max-w-2xl">
                ...
                <p className={cn("mt-3 text-sm md:text-base", UI.subtle)}>
                  Dis-nous le type (portrait / corporate / food), le rendu voulu et la deadline.
                </p>
              </div>
            </Reveal>
