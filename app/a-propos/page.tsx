...
export default function APropos() {
  return (
    <main className="bg-[#0B0B0E] text-white font-sans">
      <div className="max-w-3xl mx-auto py-20 px-4 text-white/80">
        <h1 className="text-4xl font-bold mb-8 text-[#F5C518]">À propos</h1>
        ...
        {/* NOTRE HISTOIRE */}
        <h2 className="text-2xl font-semibold mb-4 text-[#F5C518]">Notre histoire</h2>
        ...
        {/* FONDATEUR */}
        <h2 className="text-2xl font-semibold mb-4 text-[#F5C518]">Le fondateur</h2>
        <p className="mb-4 leading-relaxed text-white">
        ...
        {/* IDENTITÉ */}
        <h2 className="text-2xl font-semibold mb-4 text-[#F5C518]">Notre identité</h2>
        <p className="mb-6 leading-relaxed text-white">
        ...
        {/* MISSION */}
        <h2 className="text-2xl font-semibold mb-4 text-[#F5C518]">Notre mission</h2>
        <p className="mb-6 leading-relaxed text-white">
        ...
        {/* VALEURS */}
        <h2 className="text-2xl font-semibold mb-4 text-[#F5C518]">Nos valeurs</h2>
        <ul className="list-disc pl-6 mb-6 space-y-3 text-white">
          <li>
        ...
        {/* DIFFÉRENCE */}
        <h2 className="text-2xl font-semibold mb-4 text-[#F5C518]">Ce qui nous distingue</h2>
        <ul className="list-disc pl-6 mb-6 space-y-3 text-white">
        ...
        {/* VISION */}
        <h2 className="text-2xl font-semibold mb-4 text-[#F5C518]">Notre vision</h2>
        <p className="mb-4 leading-relaxed text-white">
